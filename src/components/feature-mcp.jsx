            ...
            <Mock className="cmp mock" minHeight="22rem">
              ...
              <div className="mock-pad">
                <div className="mcp-conn">
                  <span className="mcp-logo" data-node><img src="/assets/claude-icon.png" alt="Claude" width="104" height="104" loading="lazy" decoding="async" style={{ height: "34px", width: "auto", borderRadius: "9px" }} /><img src="/assets/chatgpt-icon.png" alt="ChatGPT" width="104" height="104" loading="lazy" decoding="async" style={{ height: "34px", width: "auto", marginLeft: ".45rem" }} /></span>
                  <span className="mcp-wire"><b data-wire></b></span>
                  <span className="mcp-logo" data-node><img src="/assets/revly-wordmark.png" alt="Revly" width="232" height="78" loading="lazy" decoding="async" style={{ height: "26px", width: "auto" }} /></span>
                </div>
