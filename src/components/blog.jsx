...
function ArticleCard({ post }) {
  ...
  return (
    <a href={`/blog/${post.slug}`} className="card" style={{ padding: "1rem", display: "flex", flexDirection: "column", gap: "1rem", transition: "transform .2s ease, box-shadow .2s ease" }} onMouseEnter={(e) => {e.currentTarget.style.transform = "translateY(-2px)";e.currentTarget.style.boxShadow = "0 10px 30px rgba(0,0,0,0.06)";}} onMouseLeave={(e) => {e.currentTarget.style.transform = "";e.currentTarget.style.boxShadow = "";}}>
...
and the mechanics behind both.</p>
            ...
            {/* Featured post card */}
            <a href={`/blog/${featured.slug}`} className="card" style={{ padding: "1rem", display: "flex", flexDirection: "column", gap: "1rem", textDecoration: "none", transition: "transform .2s ease, box-shadow .2s ease" }} onMouseEnter={(e) => {e.currentTarget.style.transform = "translateY(-2px)";e.currentTarget.style.boxShadow = "0 10px 30px rgba(0,0,0,0.06)";}} onMouseLeave={(e) => {e.currentTarget.style.transform = "";e.currentTarget.style.boxShadow = "";}}>
...
// =========================================================================
// Article page — receives slug as prop (Astro passes it via getStaticPaths)
// =========================================================================
    ...
    return <>
      ...
      <main style={{ minHeight: "60vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "4rem 1.5rem" }}>
        <div style={{ textAlign: "center", maxWidth: "480px" }}>
          ...
          <a href="/blog" className="btn btn-default" style={{ marginTop: "1.5rem" }}>← Back to blog</a>
        </div>
      </main>
      <Footer />
    </>;
      ...
      <article style={{ background: "hsl(var(--card))" }}>
        <div className="container-x" style={{ maxWidth: "760px", padding: "4rem 1.5rem 2rem" }}>
          <div style={{ display: "flex", alignItems: "center", gap: ".75rem", fontSize: ".88rem", color: "hsl(var(--foreground)/0.55)", marginBottom: "1.25rem" }}>
            <a href="/blog" style={{ color: "hsl(var(--foreground)/0.55)" }}>← Blog</a>
      ...
      <section className="section" style={{ background: "#f6f6f4" }}>
        <div className="container-x">
          <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", marginBottom: "2rem", flexWrap: "wrap", gap: "1rem" }}>
            ...
            <a href="/blog" style={{ color: "hsl(var(--primary))", fontWeight: 700, fontSize: ".95rem" }}>All articles →</a>
          </div>
